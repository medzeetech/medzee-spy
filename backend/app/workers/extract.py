...
Coexists with F4 forward-capture: F1 supplies the auto-generated
post-signup report from 30 days of history; F4 keeps capturing new
messages via the ``messages`` webhook for on-demand reports later.
